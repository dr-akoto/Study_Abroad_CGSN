...
const schools = [
  ...
  { id: 5, name: "Harvard University", logo: "/images/harvard.png" },
  { id: 6, name: "Stanford University", logo: "/images/stanford.png" },
  { id: 7, name: "Oxford University", logo: "/images/oxford.png" },
  { id: 8, name: "MIT", logo: "/images/mit.png" },
];

export default function Landing() {
  return (
    <>
      <section className="flex min-h-screen justify-center bg-gradient-to-r from-gray-900 to-gray-800">
        <Navbar />
        <div className="flex flex-col sm:flex-col md:flex-row w-full">
          <div className="flex w-full md:w-1/2 justify-center items-center px-4 md:px-10">
            <div className="relative text-center">
              ...
              <button className="bg-blue-700 w-40 h-10 px-6 py-2 mt-5 text-white rounded hover:bg-blue-600 transition duration-300">
                About Us
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto text-center px-4">
          ...
          <div className="grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <div
                key={index}
                className="p-8 border rounded-xl bg-gray-50 hover:shadow-lg hover:shadow-blue-500/50 transition duration-300"
              >
